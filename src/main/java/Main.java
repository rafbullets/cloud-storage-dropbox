...
//        files.add(new FileWrapper(new File("output1.csv"), "output1", "output1.csv", "noviFolder1/multi/"));
//        files.add(new FileWrapper(new File("output.csv"), "output", "output.csv", "noviFolder1/multi/"));
//        files.add(new FileWrapper(new File("output43.csv"), "output43", "output43.csv", "noviFolder1/multi/"));
//        d.uploadMultipleFiles(files);
        FileWrapper f = d.downloadFile("/noviFolder1/multi/", "output.csv", "outputD.csv");
